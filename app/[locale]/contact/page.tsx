...
export default async function ContactPage({
  ...
  const details = [
    { icon: MapPin, label: info.addressLabel, value: info.address },
    { icon: Phone, label: info.phoneLabel, value: info.phone, ltr: true },
    { icon: Mail, label: info.emailLabel, value: info.email, ltr: true },
      ...
      <Section>
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            {/* Map placeholder */}
            <div className="relative flex aspect-[16/10] items-center justify-center overflow-hidden rounded-3xl border border-primary-100 bg-primary-50/60">
