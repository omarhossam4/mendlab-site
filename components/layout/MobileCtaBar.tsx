    ...
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-primary-100 bg-surface/95 px-4 py-3 shadow-[0_-4px_20px_-6px_rgb(10_74_85_/0.2)] backdrop-blur lg:hidden">
      <div className="mx-auto flex max-w-md items-center gap-3">
        <a
          ...
          aria-label={dict.contact.form.whatsappCta}
          className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#25D366] text-white transition-colors hover:bg-[#1ebe5b]"
        >
